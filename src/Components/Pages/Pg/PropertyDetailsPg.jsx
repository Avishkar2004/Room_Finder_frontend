...
const PropertyDetailsPg = () => {
    ...
    const [selectedTab, setSelectedTab] = useState("RoomDetails");
    ...
    const validateCurrentTab = () => {
        switch (selectedTab) {
            case "RoomDetails":
                return RoomDetails.validateForm ? RoomDetails.validateForm() : false;
    ...
    return (
        <div className="flex flex-col justify-center items-center bg-gray-100 min-h-screen">
            ...
            <div className="flex flex-col md:flex-row mt-4 bg-white p-4 rounded-lg shadow-lg w-[90%] md:w-[80%]">
                {/* Left Sidebar */}
                <div className="w-full md:w-[20%] p-4 rounded-l-lg shadow-lg text-gray-600 bg-gray-50">
                ...
                {/* Right Sidebar */}
                <div className="hidden md:block w-1/6 p-6 bg-white shadow-md">
                    ...
                    <div className="flex flex-col space-y-4 p-4 border mt-2 border-gray-200">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            {[
                                ...
                                <div key={feature.name} className="flex flex-col items-center space-y-2 p-4 border border-gray-200 rounded-lg hover:shadow-sm transition-shadow duration-200">
