...
const Gallery = () => {
  ...
  //Function to trigger the file input when the add photos button is cliced
  ...
  return (
    <div className="flex justify-center items-center w-full p-4 bg-white shadow-lg rounded-lg">
              ...
              {images.map((image) => (
                <div key={image.id} className="relative group border rounded-lg p-2 bg-white shadow-md">
                  ...
                  <div className="mt-2 flex justify-between items-center">
                    {/* Star Button */}
                    <button className="text-xs p-2 rounded-full" onClick={() => handleToggleFavorite(image.id)}>
                      {image.isFavorite ? (
