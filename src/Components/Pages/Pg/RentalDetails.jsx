            ...
            <div className='mt-5'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex-1">
                        ...
                        <select
                            className="w-1/2 text-gray-500 p-4 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
                            onChange={handleInputChange}
                        ...
                        {errors.monthlyMaintenance && <p className='text-red-500 text-xs'>{errors.monthlyMaintenance}</p>}
                    </div>
